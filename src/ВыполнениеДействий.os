...
Процедура СоздатьХранилище(ОписаниеБазы, ПутьХранилища, ИмяПользователя, Пароль, Отказ) Экспорт
	...
	Попытка
		Конфигуратор = ОписаниеБазы.ПолучитьКонфигуратор();
		Конфигуратор.СоздатьФайловоеХранилищеКонфигурации(ПутьХранилища, ИмяПользователя, Пароль);
		ВыводЛога.Сообщение(Конфигуратор.ВыводКоманды());
		ВыводЛога.Успех("Успешно" + Символы.ПС);
	Исключение
		Отказ = Истина;
...
Процедура ПодключитьИБКХранилищу(ОписаниеБазы, ПутьХранилища, ИмяПользователя, Пароль, Отказ) Экспорт
	...
	Попытка
		Конфигуратор = ОписаниеБазы.ПолучитьКонфигуратор();
		Конфигуратор.ПодключитьсяКХранилищу(ПутьХранилища, ИмяПользователя, Пароль);
		ВыводЛога.Сообщение(Конфигуратор.ВыводКоманды());
		ВыводЛога.Успех("Успешно" + Символы.ПС);
	Исключение
		Отказ = Истина;
...
Процедура ОбновитьИБИзХранилища(ОписаниеБазы, ПутьХранилища, ИмяПользователя, Пароль, Отказ) Экспорт
	...
	Попытка
		Конфигуратор = ОписаниеБазы.ПолучитьКонфигуратор();
		Конфигуратор.ОбновитьКонфигурациюБазыДанныхИзХранилища(ПутьХранилища, ИмяПользователя, Пароль);
		ВыводЛога.Сообщение(Конфигуратор.ВыводКоманды());
		ВыводЛога.Успех("Успешно" + Символы.ПС);
	Исключение
		Отказ = Истина;
...
Процедура ОтключитьСеансы(ОписаниеБазы, ИмяАдминистратора = Неопределено, Пароль = Неопределено, Отказ = Ложь) Экспорт
